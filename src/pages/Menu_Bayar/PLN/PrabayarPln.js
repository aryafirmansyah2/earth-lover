...
const MenuPln = tw.button`w-[240px] text-[#AAAAAA] text-lg font-Medium border-b-2 focus:border-b-4  py-5 focus:rounded-sm focus:border-green-1  focus:text-green-1`
