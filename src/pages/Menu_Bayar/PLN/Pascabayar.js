...
const MenuPln = tw.button`w-full text-[#AAAAAA] text-lg font-Medium border-b-2 active:border-b-4  py-5 active:rounded-sm active:border-green-1  active:text-green-1`
