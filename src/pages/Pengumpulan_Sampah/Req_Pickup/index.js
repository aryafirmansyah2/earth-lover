...
const ChoiceContainer = tw.button`w-full flex items-center justify-center border-2 border-green-1 rounded-xl mt-4 text-[16px] font-normal text-green-1 py-3  focus:bg-green-1 focus:text-white`
